...
# Step 4: Define variables for the compliance agent
COMPLIANCE_AGENT_NAME="finops_compliance_ai_agent"
COMPLIANCE_AGENT_ENTRYPOINT="finops_compliance_ai_agent.py"
...
agentcore configure \
  ...
  --entrypoint "$COMPLIANCE_AGENT_ENTRYPOINT" \
