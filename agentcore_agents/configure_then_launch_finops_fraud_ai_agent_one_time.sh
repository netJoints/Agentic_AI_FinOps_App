...
# Step 4: Define variables for the fraud agent
FRAUD_AGENT_NAME="finops_fraud_ai_agent"
FRAUD_AGENT_ENTRYPOINT="finops_fraud_ai_agent.py"
...
agentcore configure \
  ...
  --entrypoint "$FRAUD_AGENT_ENTRYPOINT" \
